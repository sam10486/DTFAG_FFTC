...
void DTFAG::DTFAG_DIF_MixedRadix () {
    ...
    for(int k=0; k<ROM_upper_bound; k++){
        ...
        int ROM_addr = k % 16;
        if (k<16){
            ROM0_D0 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][0], bit_width);
            ROM0_D1 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][1], bit_width);
            ROM0_D2 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][2], bit_width);
            ROM0_D3 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][3], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D0[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D2[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM0_B0 << "_";
            ...
            ROM0_D4 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][4], bit_width);
            ROM0_D5 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][5], bit_width);
            ROM0_D6 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][6], bit_width);
            ROM0_D7 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][7], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D4[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D6[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM0_B0 << "_";
            //Bin_DTFAG_DIF_ROM0_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D5[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D7[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM0_B0 << endl;
            Bin_DTFAG_DIF_ROM0_B1 << endl;
        }else if(k>=32 && k<48){
            ROM0_D8 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][8], bit_width);
            ROM0_D9 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][9], bit_width);
            ROM0_D10 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][10], bit_width);
            ROM0_D11 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][11], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D8[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D10[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM0_B0 << "_";
            //Bin_DTFAG_DIF_ROM0_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D9[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D11[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM0_B0 << endl;
            Bin_DTFAG_DIF_ROM0_B1 << endl;
        }else{
            ROM0_D12 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][12], bit_width);
            ROM0_D13 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][13], bit_width);
            ROM0_D14 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][14], bit_width);
            ROM0_D15 = DecToBin.ZZ_DecToBin(ROM0[ROM_addr][15], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D12[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D14[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM0_B0 << "_";
            //Bin_DTFAG_DIF_ROM0_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM0_B0 << ROM0_D13[bit_width-1-i];
                Bin_DTFAG_DIF_ROM0_B1 << ROM0_D15[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM0_B0 << endl;
            Bin_DTFAG_DIF_ROM0_B1 << endl;
        }
    ...
    for(int k=0; k<ROM_upper_bound; k++){
        ...
        int ROM_addr = k % 16;
        if (k<16){
            ROM1_D0 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][0], bit_width);
            ROM1_D1 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][1], bit_width);
            ROM1_D2 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][2], bit_width);
            ROM1_D3 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][3], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D0[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D2[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM1_B0 << "_";
            ...
            ROM1_D4 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][4], bit_width);
            ROM1_D5 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][5], bit_width);
            ROM1_D6 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][6], bit_width);
            ROM1_D7 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][7], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D4[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D6[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM1_B0 << "_";
            //Bin_DTFAG_DIF_ROM1_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D5[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D7[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM1_B0 << endl;
            Bin_DTFAG_DIF_ROM1_B1 << endl;
        }else if(k>=32 && k<48){
            ROM1_D8 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][8], bit_width);
            ROM1_D9 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][9], bit_width);
            ROM1_D10 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][10], bit_width);
            ROM1_D11 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][11], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D8[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D10[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM1_B0 << "_";
            //Bin_DTFAG_DIF_ROM1_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D9[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D11[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM1_B0 << endl;
            Bin_DTFAG_DIF_ROM1_B1 << endl;
        }else{
            ROM1_D12 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][12], bit_width);
            ROM1_D13 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][13], bit_width);
            ROM1_D14 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][14], bit_width);
            ROM1_D15 = DecToBin.ZZ_DecToBin(ROM1[ROM_addr][15], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D12[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D14[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM1_B0 << "_";
            //Bin_DTFAG_DIF_ROM1_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM1_B0 << ROM1_D13[bit_width-1-i];
                Bin_DTFAG_DIF_ROM1_B1 << ROM1_D15[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM1_B0 << endl;
            Bin_DTFAG_DIF_ROM1_B1 << endl;
        }
    ...
    for(int k=0; k<ROM_upper_bound; k++){
        ...
        int ROM_addr = k % 16;
        if (k<16){
            ROM2_D0 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][0], bit_width);
            ROM2_D1 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][1], bit_width);
            ROM2_D2 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][2], bit_width);
            ROM2_D3 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][3], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D0[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D2[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM2_B0 << "_";
            ...
            ROM2_D4 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][4], bit_width);
            ROM2_D5 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][5], bit_width);
            ROM2_D6 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][6], bit_width);
            ROM2_D7 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][7], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D4[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D6[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM2_B0 << "_";
            //Bin_DTFAG_DIF_ROM2_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D5[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D7[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM2_B0 << endl;
            Bin_DTFAG_DIF_ROM2_B1 << endl;
        }else if(k>=32 && k<48){
            ROM2_D8 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][8], bit_width);
            ROM2_D9 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][9], bit_width);
            ROM2_D10 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][10], bit_width);
            ROM2_D11 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][11], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D8[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D10[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM2_B0 << "_";
            //Bin_DTFAG_DIF_ROM2_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D9[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D11[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM2_B0 << endl;
            Bin_DTFAG_DIF_ROM2_B1 << endl;
        }else{
            ROM2_D12 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][12], bit_width);
            ROM2_D13 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][13], bit_width);
            ROM2_D14 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][14], bit_width);
            ROM2_D15 = DecToBin.ZZ_DecToBin(ROM2[ROM_addr][15], bit_width);
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D12[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D14[bit_width-1-i];
            }
            //Bin_DTFAG_DIF_ROM2_B0 << "_";
            //Bin_DTFAG_DIF_ROM2_B1 << "_";
            for (int i = 0; i < bit_width; i++){
                Bin_DTFAG_DIF_ROM2_B0 << ROM2_D13[bit_width-1-i];
                Bin_DTFAG_DIF_ROM2_B1 << ROM2_D15[bit_width-1-i];
            }
            Bin_DTFAG_DIF_ROM2_B0 << endl;
            Bin_DTFAG_DIF_ROM2_B1 << endl;
        }           
